...
|Метод|Описание|
|----|----|
|:SetFAdminGroup(group)|Нужно указать, если итем является донат группой в FAdmin.<br>**ВНИМАНИЕ: Если у вас стоит старая версия DarkRP (до 07.02.2016) то эта функция будет выдавать привилегии даже если срок действия закончился. Обновите DarkRP.**|
